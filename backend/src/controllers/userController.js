...
const ALLOWED_ROLES = ['admin', 'engineer', 'qc', 'qc_manager', 'lab', 'lab_manager'];
...
async function createUser(req, res) {
  ...
  if (!ALLOWED_ROLES.includes(role)) {
    return res.status(400).json({ message: 'Invalid role. Use: admin, engineer, qc, qc_manager, lab, lab_manager' });
  }
