export default {
  ...
  dm2000PerfReportTab: 'Performance Report',
  dm2000PerfReportTitle: 'Battery Performance Report (Auto)',
  dm2000PerfReportDesc: 'Select archives from DM2000, assign battery type (HP/UD/UD+) and channel range, then download an Excel with results and uniform rates pre-filled.',
  dm2000PerfStep1: 'Step 1: Search and select archives',
  dm2000PerfStep2: 'Step 2: Configure report entries',
  dm2000PerfAddSelected: 'Add selected to report',
  dm2000PerfAddSingle: 'Add to report',
  dm2000PerfEntries: 'Report entries',
  dm2000PerfBatteryType: 'Battery type',
  dm2000PerfBatys: 'Channel(s) (e.g. 1-4 or 1,2,3,4)',
  dm2000PerfAllBatys: 'All channels',
  dm2000PerfSheetName: 'Sheet name',
  dm2000PerfSheetNameHint: 'Default: Type + Serial No',
  dm2000PerfRemove: 'Remove',
  dm2000PerfDownload: 'Download performance report (.xlsx)',
  dm2000PerfDownloading: 'Generating report...',
  dm2000PerfNoEntries: 'No entries yet. Add archives from step 1.',
  dm2000PerfSuccess: 'Report downloaded successfully',
  dm2000PerfError: 'Report generation failed',
  dm2000PerfSelectStation: 'Please select a station first',
  dm2000PerfArchiveName: 'Archive',
