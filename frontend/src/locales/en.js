export default {
  ...
  remarkReload: 'Reload',
  remarkEditMode: 'Edit mode',
  remarkLoadFailedTitle: 'Could not load editable list from server',
  remarkLoadFailedDesc: 'Falling back to the built-in default list.',
  remarkNoPresets: 'No presets defined yet. Switch to Edit mode to add some.',
  remarkAddPreset: 'Add preset',
  remarkEditPreset: 'Edit preset',
  remarkPresetCreated: 'Preset added',
  remarkPresetUpdated: 'Preset updated',
  remarkPresetDeleted: 'Preset deleted',
  remarkSaveFailed: 'Save failed',
  remarkSave: 'Save',
  remarkCancel: 'Cancel',
  remarkEdit: 'Edit',
  remarkConfirmDelete: 'Delete this entry?',
  remarkConfirmDeleteOk: 'Delete',
  remarkConfirmDeleteCancel: 'Cancel',
  remarkFamily: 'Battery family',
  remarkFamilyRequired: 'Family is required',
  remarkConditionRequired: 'Condition text is required',
  remarkKeyword: 'Keyword',
  remarkKeywordRequired: 'Keyword is required',
  remarkKeywordHint: 'Case-insensitive substring matched against the battery type (e.g. dcxh).',
  remarkSortOrder: 'Order',
  remarkSortOrderHint: 'Lower numbers are checked first. Put more specific keywords (LR03, LR61) before generic ones (LR6).',
  remarkAddKeyword: 'Add keyword',
  remarkEditKeyword: 'Edit keyword',
  remarkKeywordCreated: 'Keyword added',
  remarkKeywordUpdated: 'Keyword updated',
  remarkKeywordDeleted: 'Keyword deleted',
  remarkKeywordsSection: 'Family detection keywords',
  remarkKeywordsHelp: 'These keywords are matched against the battery type to suggest a default family (LR6, LR03, ...).',
