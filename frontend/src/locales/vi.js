export default {
  ...
  moveFileTitle: 'Di chuyển file đến...',
  ...
  batteryViewOnly: 'Chế độ xem',
  batteryViewOnlyDesc: 'Trạm đang được sử dụng bởi máy khác. Bạn chỉ có thể xem kết quả và biểu đồ đo.',
  batteryStationOccupied: 'Trạm đang bận',
  batteryStationOccupiedHint: 'Có máy khác đang kết nối. Bạn không thể thao tác.',
  ...
  batteryOcvStandard: 'Tiêu chuẩn OCV (từ - đến)',
  ...
  batteryDuplicateOrderTitle: 'Mã đơn hàng đã tồn tại trong lịch sử!',
  batteryDuplicateOrderDesc: 'Mã đơn hàng này đã có dữ liệu đo trong lịch sử. Nếu bạn tiếp tục đo với mã này, toàn bộ dữ liệu cũ trong lịch sử sẽ bị ghi đè và mất hết.',
  batteryDuplicateOrderExisting: 'Mã đơn hàng',
  batteryDuplicateOrderCount: 'Kết quả đã lưu',
  batteryDuplicateOrderLoadOld: 'Tải lại đơn cũ',
  batteryDuplicateOrderUseOther: 'Dùng mã khác',
  ...
  batteryClearSessionSaveTitle: 'Lưu thay đổi trước khi xóa?',
  batteryClearSessionSaveContent: 'Có thay đổi chưa được lưu. Bạn có muốn lưu lại trước khi xóa phiên?',
  batteryClearSessionSaveAndClear: 'Lưu và xóa',
  batteryClearSessionClearOnly: 'Xóa không lưu',
  ...
  batterySetupTab: 'Thiết lập thông số',
  batterySetupAddEdit: 'Thêm / Sửa thông số',
  batterySetupSave: 'Lưu thông số',
  batterySetupSaved: 'Đã lưu thông số',
  ...
  batteryManageTypes: 'Quản lý loại pin',
  batteryManageLines: 'Quản lý dòng sản phẩm',
  batteryAddType: 'Thêm loại pin',
  batteryAddLine: 'Thêm dòng sản phẩm',
  batteryTypeNamePlaceholder: 'Tên loại pin (vd: LR6)',
  batteryLineNamePlaceholder: 'Tên dòng sản phẩm (vd: UD+)',
  batteryTypeAdded: 'Đã thêm loại pin',
  batteryLineAdded: 'Đã thêm dòng sản phẩm',
  batteryTypeDeleted: 'Đã xóa loại pin',
  batteryLineDeleted: 'Đã xóa dòng sản phẩm',
  batteryTypeExists: 'Loại pin đã tồn tại',
  ...
  engineerRole: 'Kỹ sư',
  qcRole: 'QC',
  qcManagerRole: 'QC Chủ quản',
  labRole: 'Nhân viên thí nghiệm',
  labManagerRole: 'Giám đốc Lab',
  ...
  dmpSearchTab: 'Tải dữ liệu',
  dmpDataTab: 'Bảng dữ liệu',
  dmpSelectBatchToView: 'Chọn lô để xem dữ liệu',
  ...
  dm3000Title: 'DM3000',
  dm3000SearchTab: 'Tải dữ liệu',
  dm3000CurveTab: 'Biểu đồ',
  dm3000DataTab: 'Dữ liệu',
  dm3000DailyVoltTab: 'Điện áp hàng ngày',
  dm3000ExportTab: 'Xuất báo cáo',
  dm3000DischargeCurrent: 'Dòng phóng điện',
  ...
  dm2000DisConditionFilter: 'Lọc điều kiện phóng',
  dm2000KeywordFilter: 'Tìm kiếm',
  dm2000KeywordFilterPlaceholder: 'Kiểu pin, tên lô, điều kiện phóng, NSX, số seri...',
  ...
  cbServiceNoModel: 'Dịch vụ AI: không tải được mô hình',
  cbServiceNoModelDesc: 'Dịch vụ AI đang chạy nhưng không tải được file mô hình (best.onnx / best.pt). Vui lòng kiểm tra file mô hình trong thư mục models/ và thử tải lại.',
  cbReloadModel: 'Tải lại mô hình',
  cbModelReloaded: 'Mô hình đã tải lại thành công',
  cbModelReloadFailed: 'Tải lại mô hình thất bại',
  ...
  dmpPerfReportTab: 'Báo Cáo Hiệu Suất',
  dmpPerfReportTitle: 'Báo cáo hiệu suất pin (Bảng theo dõi hiệu suất pin)',
  dmpPerfRemarkTab: 'Dữ liệu Remark',
  dmpPerfTemplateTab: 'Mẫu Báo Cáo',
  dmpPerfExportTab: 'Xuất Báo Cáo',
  dmpPerfAddEntry: 'Thêm mục',
  dmpPerfAddFromBatch: 'Thêm từ lô đã chọn',
  dmpPerfNoEntries: 'Chưa có mục nào. Thêm mục để tạo báo cáo.',
  dmpPerfEntryBatchId: 'Mã lô (Batch ID)',
  dmpPerfEntryDate: 'Ngày',
  dmpPerfEntryModel: 'Loại pin',
  ...
  dmpPerfCancelEntry: 'Hủy',
  dmpPerfDeleteEntry: 'Xóa mục',
  dmpPerfDeleteConfirm: 'Xóa mục này?',
  dmpPerfEditEntry: 'Sửa',
  dmpPerfEntrySaved: 'Đã lưu mục',
  dmpPerfEntrySaveFailed: 'Lưu mục thất bại',
  dmpPerfEntryDeleted: 'Đã xóa mục',
  dmpPerfEntryDeleteFailed: 'Xóa mục thất bại',
  dmpPerfSelectTemplate: 'Chọn mẫu báo cáo',
  dmpPerfNoTemplates: 'Chưa có mẫu nào. Tải lên mẫu .xlsx.',
  dmpPerfUploadTemplate: 'Tải lên mẫu (.xlsx)',
  dmpPerfTemplateUploaded: 'Tải lên mẫu thành công',
  dmpPerfTemplateUploadFailed: 'Tải lên mẫu thất bại',
  dmpPerfGenerate: 'Tạo & Tải xuống Báo cáo',
  dmpPerfGenerating: 'Đang tạo báo cáo…',
  dmpPerfNoTemplate: 'Vui lòng chọn mẫu báo cáo trước',
  dmpPerfNoEntriesToExport: 'Vui lòng thêm ít nhất một mục trước khi tạo báo cáo',
  dmpPerfReportDownloaded: 'Đã tải xuống báo cáo',
  dmpPerfReportFailed: 'Tạo báo cáo thất bại',
  dmpPerfSelectStation: 'Vui lòng chọn trạm trước',
  dmpPerfHint: 'Đăng ký mục DMP và mục DM2000 tại đây. Mỗi mục ánh xạ một bài kiểm tra phóng điện vào một hàng trong mẫu báo cáo. Cả dữ liệu DMP và DM2000 đều hiển thị chung trong Xem Báo Cáo.',
  ...
  dmpPerfViewTab: 'Xem Báo Cáo',
  dmpPerfViewPreview: 'Xem trước',
  dmpPerfViewLoading: 'Đang tải dữ liệu hiệu suất…',
  dmpPerfViewNoData: 'Chưa có dữ liệu. Thêm mục và nhấn Xem trước.',
  dmpPerfViewFilterModel: 'Loại pin',
  dmpPerfViewFilterLoai: 'Mẫu (UD/HP/UD+)',
  dmpPerfViewFilterChuyen: 'Chuyền',
  dmpPerfViewSheet: 'Sheet',
  dmpPerfViewDate: 'Ngày',
  dmpPerfViewLoaiCol: 'Mẫu',
  ...
  dmpPerfImportSkipped: 'Bỏ qua {count} mục trùng',
  dmpPerfImportFailed: 'Nhập thất bại',
  dmpPerfExportFailed: 'Xuất thất bại',
  dmpPerfDeleteAllEntries: 'Xóa tất cả',
  dmpPerfDeleteAllTitle: 'Xóa toàn bộ dữ liệu',
  dmpPerfDeleteAllWarning: 'Thao tác này sẽ xóa TOÀN BỘ dữ liệu của trạm này. Nhập mật khẩu admin để xác nhận.',
  dmpPerfDeleteAllPasswordPlaceholder: 'Nhập mật khẩu của bạn',
  dmpPerfDeleteAllPasswordRequired: 'Vui lòng nhập mật khẩu',
  dmpPerfDeleteAllConfirmBtn: 'Xóa tất cả',
  dmpPerfDeleteAllSuccess: 'Đã xóa {count} mục',
  dmpPerfDeleteAllFailed: 'Xóa thất bại',
  qc: {
    module_name: 'Quản lý Chất lượng PIN',
    nav_dashboard: 'Bảng điều khiển QC',
    nav_entry: 'Nhập liệu xưởng',
    nav_dictionaries: 'Quản lý từ điển',
    dashboard_title: 'Tổng quan chất lượng',
    dashboard_filter_title: 'Bộ lọc năm, dây chuyền, model và loại lỗi',
    total_records: 'Tổng bản ghi',
    monthly_ppm: 'PPM tháng',
    defects_by_type: 'Lỗi theo loại',
    total_output: 'Tổng sản lượng',
    monthly_summary: 'Tổng hợp theo tháng',
    yearly_trend: 'Xu hướng theo năm',
    select_year: 'Chọn năm',
    year_range: 'Khoảng năm',
    line_filter: 'Lọc dây chuyền',
    model_filter: 'Lọc model',
    defect_filter: 'Lọc loại lỗi',
    refresh: 'Làm mới',
    no_data: 'Không có dữ liệu',
    current_month: 'Tháng hiện tại',
    top_defect: 'Lỗi nổi bật',
    defect_count: 'Số lỗi',
    production_title: 'Sản lượng',
    add_output: 'Thêm sản lượng',
    edit_output: 'Sửa sản lượng',
    production_year: 'Năm sản xuất',
    production_month: 'Tháng sản xuất',
    output_qty: 'Sản lượng',
    note: 'Ghi chú',
    line_code: 'Mã dây chuyền',
    line_desc: 'Mô tả dây chuyền',
    ...
    entry_title: 'Nhập liệu xưởng',
    scan_barcode: 'Quét hoặc nhập mã upper/lower',
    detected_date: 'Ngày phát hiện',
    upper_code: 'Mã upper',
    lower_code: 'Mã lower',
    found_department: 'Bộ phận phát hiện',
    ocv: 'OCV',
    building_no: 'Số Khay',
    upper_code_placeholder: 'Nhập mã upper...',
    lower_code_placeholder: 'Nhập mã lower...',
    found_department_placeholder: 'Nhập bộ phận phát hiện...',
    ocv_placeholder: 'Nhập OCV...',
    building_no_placeholder: 'Nhập số khay...',
    parse_result: 'Kết quả phân tích mã',
    product_line: 'Dây chuyền',
    grade: 'Cấp độ',
    station: 'Công đoạn',
    suffix: 'Hậu tố',
    special_status: 'Trạng thái đặc biệt',
    defect_type: 'Loại lỗi',
    defect_description: 'Mô tả lỗi',
    defect_description_placeholder: 'Nhập mô tả lỗi...',
    upload_photo: 'Upload ảnh',
    operator_name: 'Người nhập',
    submit_record: 'Ghi nhận',
    parse_only: 'Chỉ phân tích',
    submit_success: 'Lưu bản ghi thành công.',
    history: 'Lịch sử nhập liệu',
    search_placeholder: 'Tìm kiếm...',
    start_date: 'Từ ngày',
    end_date: 'Đến ngày',
    record_time: 'Thời gian ghi nhận',
    dict_title: 'Quản lý từ điển mã',
    dict_line: 'Mã dây chuyền',
    dict_defect: 'Loại lỗi',
    dict_year: 'Mã năm',
    dict_month: 'Mã tháng',
    dict_grade: 'Mã cấp độ',
    dict_suffix: 'Mã hậu tố',
    add_entry: 'Thêm mới',
    edit_entry: 'Chỉnh sửa',
    import_csv: 'Nhập CSV',
    export_csv: 'Xuất CSV',
    import_success: 'Nhập dữ liệu thành công.',
    import_error: 'Nhập dữ liệu thất bại.',
    export_success: 'Xuất dữ liệu thành công.',
    code_field: 'Mã',
    line_desc_field: 'Mô tả dây chuyền',
    battery_model_field: 'Model pin',
    active_field: 'Hoạt động',
    name_field: 'Tên',
    year_value_field: 'Giá trị năm',
    month_value_field: 'Giá trị tháng',
    grade_desc_field: 'Mô tả cấp độ',
    suffix_code_field: 'Mã hậu tố',
    status_desc_field: 'Mô tả trạng thái',
    enabled: 'Bật',
    disabled: 'Tắt',
    id_field: 'ID',
    filter_conditions: 'Điều kiện lọc bảng',
    date_range: 'Khoảng ngày phát hiện',
    line_multi: 'Dây chuyền (nhiều chọn)',
    model_multi: 'Mẫu pin (nhiều chọn)',
    defect_multi: 'Loại lỗi (nhiều chọn)',
    trend_title: 'Xu hướng lỗi (theo ngày phát hiện)',
    pie_title: 'Tóm tắt lỗi (phân bố theo loại)',
    ppm_title: 'Xu hướng PPM (theo dây chuyền/mẫu)',
    ppm_mismatch_warning: 'Có bản ghi lỗi trong khoảng lọc, nhưng không tìm thấy sản lượng khớp cùng dây chuyền, model và tháng. Hãy kiểm tra lại dữ liệu sản lượng.',
    history_title: 'Lịch sử chất lượng (tìm kiếm/lọc/sắp xếp/xóa)',
    history_search: 'Tìm kiếm (mã/người nhập/tên lỗi/mô tả/bộ phận/OCV/tòa)',
    sort_record_id: 'ID bản ghi',
    sort_record_time: 'Thời gian ghi',
    sort_detected_date: 'Ngày phát hiện',
    sort_production_time: 'Thời gian sản xuất',
    desc: 'Giảm dần',
    asc: 'Tăng dần',
    query: 'Truy vấn',
    month_placeholder: 'Tháng',
    month_suffix: '',
    line_required: 'Mã dây chuyền',
    line_required_msg: 'Vui lòng chọn mã dây chuyền.',
    select_line: 'Chọn dây chuyền',
    auto_fill: 'Tự động điền',
    search_production: 'Tìm dây chuyền/mẫu/ghi chú',
    output_updated_existing: 'Đã cập nhật bản ghi sản lượng hiện có cho cùng năm, tháng và dây chuyền.',
    updated_at: 'Cập nhật lúc',
    operator_placeholder: 'Nhập tên/mã nhân viên',
    upload_photo_optional: 'Ảnh hiện trường (tùy chọn)',
    select_photo: 'Chọn ảnh',
    take_photo: 'Chụp ảnh',
    no_photo_selected: 'Chưa chọn ảnh',
    clear_photo: 'Xóa ảnh',
    photo_tip: 'Hỗ trợ jpg/jpeg/png/bmp/webp, tối đa 1 ảnh.',
    defect_type_single: 'Loại lỗi (chọn một)',
    select_defect_type: 'Chọn loại lỗi',
    submit_and_parse: 'Gửi & Phân tích',
    preview_parse: 'Chỉ xem trước phân tích',
    parsed_time: 'Thời gian sản xuất',
    site_photo: 'Ảnh hiện trường',
    suffix_tag: 'Thẻ hậu tố',
    warn_fill_code: 'Vui lòng nhập cả mã upper và lower.',
    warn_fill_all: 'Vui lòng nhập đầy đủ các trường bắt buộc trước khi gửi.',
    export_excel: 'Xuất Excel',
    import_excel: 'Nhập Excel',
    delete_confirm: 'Xác nhận xóa bản ghi này?',
    parse_error: 'Không thể phân tích mã. Kiểm tra lại mã nhập.',
  },
};
