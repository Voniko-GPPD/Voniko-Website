export default {
  ...
  remarkReload: 'Tải lại',
  remarkEditMode: 'Chế độ sửa',
  remarkLoadFailedTitle: 'Không tải được danh sách từ máy chủ',
  remarkLoadFailedDesc: 'Đang dùng danh sách mặc định tích hợp sẵn.',
  remarkNoPresets: 'Chưa có điều kiện nào. Bật chế độ sửa để thêm.',
  remarkAddPreset: 'Thêm điều kiện',
  remarkEditPreset: 'Sửa điều kiện',
  remarkPresetCreated: 'Đã thêm điều kiện',
  remarkPresetUpdated: 'Đã cập nhật điều kiện',
  remarkPresetDeleted: 'Đã xoá điều kiện',
  remarkSaveFailed: 'Lưu thất bại',
  remarkSave: 'Lưu',
  remarkCancel: 'Huỷ',
  remarkEdit: 'Sửa',
  remarkConfirmDelete: 'Xoá mục này?',
  remarkConfirmDeleteOk: 'Xoá',
  remarkConfirmDeleteCancel: 'Huỷ',
  remarkFamily: 'Dòng pin',
  remarkFamilyRequired: 'Vui lòng nhập dòng pin',
  remarkConditionRequired: 'Vui lòng nhập nội dung điều kiện',
  remarkKeyword: 'Từ khoá',
  remarkKeywordRequired: 'Vui lòng nhập từ khoá',
  remarkKeywordHint: 'So khớp không phân biệt hoa thường, dạng substring với loại pin (ví dụ: dcxh).',
  remarkSortOrder: 'Thứ tự',
  remarkSortOrderHint: 'Số nhỏ hơn được kiểm tra trước. Đặt từ khoá cụ thể (LR03, LR61) trước từ khoá chung (LR6).',
  remarkAddKeyword: 'Thêm từ khoá',
  remarkEditKeyword: 'Sửa từ khoá',
  remarkKeywordCreated: 'Đã thêm từ khoá',
  remarkKeywordUpdated: 'Đã cập nhật từ khoá',
  remarkKeywordDeleted: 'Đã xoá từ khoá',
  remarkKeywordsSection: 'Từ khoá nhận diện dòng pin',
  remarkKeywordsHelp: 'Các từ khoá này dùng để so khớp với loại pin và gợi ý dòng pin mặc định (LR6, LR03, ...).',
