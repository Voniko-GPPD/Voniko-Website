export default {
  ...
  dm2000PerfReportTab: 'Báo cáo hiệu suất',
  dm2000PerfReportTitle: 'Báo cáo hiệu suất pin (Tự động)',
  dm2000PerfReportDesc: 'Chọn các archive từ DM2000, gán loại pin (HP/UD/UD+) và phạm vi kênh, rồi tải báo cáo Excel được điền sẵn kết quả và tỉ lệ.',
  dm2000PerfStep1: 'Bước 1: Tìm và chọn archive',
  dm2000PerfStep2: 'Bước 2: Cấu hình từng mục báo cáo',
  dm2000PerfAddSelected: 'Thêm đã chọn vào báo cáo',
  dm2000PerfAddSingle: 'Thêm vào báo cáo',
  dm2000PerfEntries: 'Danh sách mục báo cáo',
  dm2000PerfBatteryType: 'Loại pin',
  dm2000PerfBatys: 'Kênh pin (ví dụ: 1-4 hoặc 1,2,3,4)',
  dm2000PerfAllBatys: 'Tất cả kênh',
  dm2000PerfSheetName: 'Tên sheet',
  dm2000PerfSheetNameHint: 'Mặc định: Loại pin + Số seri',
  dm2000PerfRemove: 'Xóa',
  dm2000PerfDownload: 'Tải báo cáo hiệu suất (.xlsx)',
  dm2000PerfDownloading: 'Đang tạo báo cáo...',
  dm2000PerfNoEntries: 'Chưa có mục nào. Thêm archive từ bước 1.',
  dm2000PerfSuccess: 'Tải báo cáo thành công',
  dm2000PerfError: 'Lỗi khi tạo báo cáo',
  dm2000PerfSelectStation: 'Vui lòng chọn trạm trước',
  dm2000PerfArchiveName: 'Tên archive',
