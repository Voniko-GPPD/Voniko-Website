export default {
  ...
  remarkReload: '重新加载',
  remarkEditMode: '编辑模式',
  remarkLoadFailedTitle: '无法从服务器加载列表',
  remarkLoadFailedDesc: '正在使用内置默认列表。',
  remarkNoPresets: '尚未定义条件。开启编辑模式以添加。',
  remarkAddPreset: '添加条件',
  remarkEditPreset: '编辑条件',
  remarkPresetCreated: '已添加',
  remarkPresetUpdated: '已更新',
  remarkPresetDeleted: '已删除',
  remarkSaveFailed: '保存失败',
  remarkSave: '保存',
  remarkCancel: '取消',
  remarkEdit: '编辑',
  remarkConfirmDelete: '确定删除该条目？',
  remarkConfirmDeleteOk: '删除',
  remarkConfirmDeleteCancel: '取消',
  remarkFamily: '电池族',
  remarkFamilyRequired: '请填写电池族',
  remarkConditionRequired: '请填写条件内容',
  remarkKeyword: '关键字',
  remarkKeywordRequired: '请填写关键字',
  remarkKeywordHint: '不区分大小写的子串匹配，与电池类型（dcxh）比对。',
  remarkSortOrder: '顺序',
  remarkSortOrderHint: '数字小者优先匹配。请将更具体的关键字（LR03、LR61）排在通用关键字（LR6）之前。',
  remarkAddKeyword: '添加关键字',
  remarkEditKeyword: '编辑关键字',
  remarkKeywordCreated: '已添加关键字',
  remarkKeywordUpdated: '已更新关键字',
  remarkKeywordDeleted: '已删除关键字',
  remarkKeywordsSection: '电池族识别关键字',
  remarkKeywordsHelp: '系统会用这些关键字匹配电池类型，从而推荐默认电池族（LR6, LR03 等）。',
