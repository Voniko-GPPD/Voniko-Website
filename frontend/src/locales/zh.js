export default {
  ...
  dm2000PerfReportTab: '性能报告',
  dm2000PerfReportTitle: '电池性能报告（自动）',
  dm2000PerfReportDesc: '从DM2000选择档案，分配电池类型(HP/UD/UD+)和通道范围，然后下载预填结果和均匀率的Excel报告。',
  dm2000PerfStep1: '第一步：搜索并选择档案',
  dm2000PerfStep2: '第二步：配置报告条目',
  dm2000PerfAddSelected: '将所选添加到报告',
  dm2000PerfAddSingle: '添加到报告',
  dm2000PerfEntries: '报告条目',
  dm2000PerfBatteryType: '电池类型',
  dm2000PerfBatys: '通道（如 1-4 或 1,2,3,4）',
  dm2000PerfAllBatys: '所有通道',
  dm2000PerfSheetName: '工作表名称',
  dm2000PerfSheetNameHint: '默认：型号 + 序列号',
  dm2000PerfRemove: '删除',
  dm2000PerfDownload: '下载性能报告（.xlsx）',
  dm2000PerfDownloading: '正在生成报告...',
  dm2000PerfNoEntries: '暂无条目，请从第一步添加档案。',
  dm2000PerfSuccess: '报告下载成功',
  dm2000PerfError: '报告生成失败',
  dm2000PerfSelectStation: '请先选择站点',
  dm2000PerfArchiveName: '档案名称',
