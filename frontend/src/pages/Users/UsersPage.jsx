...
export default function UsersPage() {
  ...
  const roleLabel = (role) => {
    const map = {
      admin: t('admin'),
      engineer: t('engineerRole'),
      qc: t('qcRole'),
      qc_manager: t('qcManagerRole'),
      lab: t('labRole'),
      lab_manager: t('labManagerRole'),
    };
    return map[role] || role;
  };

  const roleColor = (role) => {
    const map = { admin: 'red', engineer: 'green', qc: 'orange', qc_manager: 'gold', lab: 'purple', lab_manager: 'geekblue' };
          ...
          >
            <Select
              ...
              options={[
                ...
                { value: 'qc_manager', label: t('qcManagerRole') },
                { value: 'lab', label: t('labRole') },
                { value: 'lab_manager', label: t('labManagerRole') },
              ]}
            />
          </Form.Item>
